...
export default function Navbar() {
  ...
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-50 bg-[var(--color-bg)]/90 backdrop-blur-md border-b border-[var(--color-border)]"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden border-t border-[var(--color-border)] px-6 sm:px-8 overflow-hidden"
            ...
            <div className="flex flex-col gap-4 py-4">
              {navItems.map((item) => (
                <Link
                  ...
                  href={item.href}
                  className="font-display font-medium text-base text-[var(--color-ink)]"
