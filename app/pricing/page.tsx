...
export default function PricingPage() {
  return (
    <main className="min-h-screen bg-[var(--color-bg)]">
      ...
      {/* ─── HERO ─── */}
      <section className="relative pt-40 pb-20 md:pt-48 md:pb-28 border-b border-[var(--color-border)] overflow-hidden">
      ...
      {/* ─── HOW PRICING WORKS ─── */}
      <section className="py-24 md:py-32 border-b border-[var(--color-border)] bg-[var(--color-bg)]">
        <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-16">
          <h2 className="text-[clamp(2rem,4vw,3.5rem)] font-bold text-[var(--color-ink)] leading-tight mb-6 break-words">
            Two-step pricing structure.
          </h2>
          <p className="text-lg md:text-xl text-[var(--color-ink-muted)] leading-relaxed max-w-2xl mb-16 break-words">
            We align pricing with typical software migration phases.
          </p>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            {/* Step 1 */}
            <div className="border-2 border-[var(--color-ink)] p-8 md:p-12">
              <p className="text-lg font-bold text-[var(--color-accent)] mb-4">
                01
              </p>
              <h3 className="text-2xl sm:text-3xl font-bold text-[var(--color-ink)] mb-6 break-words">
                Audit &amp; Integration
              </h3>
              <p className="text-lg text-[var(--color-ink-muted)] leading-relaxed mb-8 break-words">
              ...
              <div className="border-t border-[var(--color-border)] pt-6">
                <p className="text-base text-[var(--color-ink-muted)] leading-relaxed break-words">
                  Includes: On-premises deployment, automated system architecture mapping, local LLM configuration, baseline system graph, and initial characterization test suite.
                </p>
              </div>
            </div>

            {/* Step 2 */}
            <div className="border-2 border-[var(--color-ink)] border-t-0 lg:border-t-2 lg:border-l-0 p-8 md:p-12">
              <p className="text-lg font-bold text-[var(--color-accent)] mb-4">
                02
              </p>
              <h3 className="text-2xl sm:text-3xl font-bold text-[var(--color-ink)] mb-6 break-words">
      ...
      <section className="py-24 md:py-32 border-b border-[var(--color-border)] bg-[var(--color-bg)]">
        <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-16">
          ...
          <p className="text-lg md:text-xl text-[var(--color-ink-muted)] leading-relaxed max-w-2xl mb-20 break-words">
            Choose a plan based on your deployment requirements, codebase size, and team structure.
          </p>

          {/* Enterprise */}
          <div className="mb-20 pb-20 border-b border-[var(--color-border)]">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
              <div className="lg:col-span-5">
                <h3 className="text-3xl sm:text-4xl font-bold text-[var(--color-ink)] mb-4 break-words">
                  Enterprise
                </h3>
                <p className="text-lg text-[var(--color-accent)] font-bold">
                  $50,000 – $250,000+ / year
                </p>
              </div>
              <div className="lg:col-span-7">
                <p className="text-lg md:text-xl text-[var(--color-ink-muted)] leading-relaxed mb-6 break-words">
                ...
                <p className="text-lg text-[var(--color-ink)] font-medium break-words">
          ...
          <div className="mb-20 pb-20 border-b border-[var(--color-border)]">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
              ...
              <div className="lg:col-span-7">
                ...
                <p className="text-lg text-[var(--color-ink)] font-medium break-words">
                  Designed for: Engineering teams modernizing individual enterprise applications, complex operational flows, or legacy ERP integrations.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            <div className="lg:col-span-4">
              ...
              <p className="text-lg md:text-xl text-[var(--color-ink-muted)] leading-relaxed break-words">
            ...
            <div className="lg:col-span-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-10">
                <div>
                  <h4 className="text-xl font-bold text-[var(--color-ink)] mb-3">System Mapping</h4>
                  <p className="text-[var(--color-ink-muted)] leading-relaxed">
                    Automated architecture mapping to trace operational workflows and component dependencies.
                  </p>
                </div>
                <div>
                  <h4 className="text-xl font-bold text-[var(--color-ink)] mb-3">Continuous Updates</h4>
                  <p className="text-[var(--color-ink-muted)] leading-relaxed">
                    Dependency graphs update automatically on every commit via CI/CD pipelines.
                  </p>
                </div>
                <div>
                  <h4 className="text-xl font-bold text-[var(--color-ink)] mb-3">Automated Test Generation</h4>
                  <p className="text-[var(--color-ink-muted)] leading-relaxed">
                    Characterization tests and Gherkin scenarios generated directly from system behavior.
                  </p>
                </div>
                <div>
                  <h4 className="text-xl font-bold text-[var(--color-ink)] mb-3">Pull Request Specifications</h4>
                  <p className="text-[var(--color-ink-muted)] leading-relaxed">
                    Merge-ready pull requests containing technical specifications and code changes for developer review.
                  </p>
                </div>
                <div>
                  <h4 className="text-xl font-bold text-[var(--color-ink)] mb-3">Task Export</h4>
                  <p className="text-[var(--color-ink-muted)] leading-relaxed">
                    Jira tasks linked to the dependency graph, containing defined technical scope and execution steps.
                  </p>
                </div>
                <div>
                  <h4 className="text-xl font-bold text-[var(--color-ink)] mb-3">On-Premises Deployment</h4>
                  <p className="text-[var(--color-ink-muted)] leading-relaxed">
              ...
              <div className="mt-16 pt-10 border-t border-[var(--color-border)]">
                <h4 className="text-xl font-bold text-[var(--color-ink)] mb-4">Optional Add-ons</h4>
      ...
      <section className="py-24 md:py-32 border-b border-[var(--color-border)] bg-[var(--color-bg)]">
        <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
            <div className="lg:col-span-7">
              <h2 className="text-[clamp(2rem,4vw,3.5rem)] font-bold text-[var(--color-ink)] leading-tight mb-10 break-words">
              ...
              <div className="space-y-8">
                ...
                <p className="text-lg md:text-xl text-[var(--color-ink)] font-medium leading-relaxed break-words">
      ...
      <section className="py-24 md:py-32 border-b border-[var(--color-border)] bg-[var(--color-bg)]">
        <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-16">
          <h2 className="text-[clamp(2rem,4vw,3.5rem)] font-bold text-[var(--color-ink)] leading-tight mb-16 break-words">
            Frequently Asked Questions
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-14 max-w-5xl">
            <div>
              <h3 className="text-xl font-bold text-[var(--color-ink)] mb-4">What factors influence the integration fee?</h3>
              <p className="text-[var(--color-ink-muted)] leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold text-[var(--color-ink)] mb-4">Are there usage limits or per-token fees?</h3>
              <p className="text-[var(--color-ink-muted)] leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold text-[var(--color-ink)] mb-4">Is on-premises deployment supported?</h3>
              <p className="text-[var(--color-ink-muted)] leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold text-[var(--color-ink)] mb-4">Can we pilot the platform on a single application?</h3>
              <p className="text-[var(--color-ink-muted)] leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold text-[var(--color-ink)] mb-4">Is the platform compliant with regulated industry standards?</h3>
              <p className="text-[var(--color-ink-muted)] leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold text-[var(--color-ink)] mb-4">Do you offer pricing for system integrators?</h3>
              <p className="text-[var(--color-ink-muted)] leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold text-[var(--color-ink)] mb-4">What is included in technical support plans?</h3>
              <p className="text-[var(--color-ink-muted)] leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold text-[var(--color-ink)] mb-4">How long does integration take?</h3>
              <p className="text-[var(--color-ink-muted)] leading-relaxed">
